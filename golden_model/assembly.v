...
parameter SUCCESS_COUNT        =  6'd3;
parameter TEST_COUNT           = {6'b0, 6'd2};

parameter JMP_LOAD             =  6'd2;
parameter JMP_STORE_AGAIN      = {6'b0, 6'b11_1011}; //    -5   =>   00_0101   =>   11_1010 + 1   =>   11_1011
parameter FINISH_LOAD          =  6'd2;
parameter JMP_LOAD_AGAIN       = {6'b0, 6'b11_0101}; //   -11   =>   00_1011   =>   11_0100 + 1   =>   11_0101
